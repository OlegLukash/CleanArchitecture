        ...
        public static async Task Seed(OnlineBookShopDbContext context)
        {
            if (!context.Books.Any())
            {
                var bigData = new Book()
                {
                    ...
                    { 
                        new () { VoterName = "John Smith", NumStars = 5, Comment = "Great explanation of both the theory and practice of the lambda architecture. " },
                        new () { VoterName = "Jon Doe", NumStars = 4, Comment = "The only downside to the book is that the architecture and exosystem is so new that there's not really a lot of pragmatic solutions." },
                        new () { VoterName = "David Yuan", NumStars = 1, Comment = "This book has a bad binding. I bought this book and opened it only twice and it is already broken" }
                    }
                };
                ...
                var kubernetes = new Book()
                {
                    ...
                    Reviews = new List<Review>()
                    {
                        new () { VoterName = "Antonio Paes", NumStars = 4, Comment = " Content is great but as I started to turn the pages, they started to fall off." },
                        new () { VoterName = "Jon Doe", NumStars = 5, Comment = "With this book i found it clear, concise and explained in such a way that everyone with little or no background in IT can understand." },
                        new () { VoterName = "David Yuan", NumStars = 5, Comment = "I found it very interesting, well written and pleasant to read as well. This book helped me a lot and i'm sure it can help a lot beginners with this subject." }
                    }
                };
